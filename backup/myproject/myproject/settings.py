...
MIDDLEWARE = [
    ...
    "django.middleware.locale.LocaleMiddleware",  # Add this line for language middleware
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "myproject.context_processors.institution_settings",  # Add this line
...
# The following settings should help with displaying translation files
