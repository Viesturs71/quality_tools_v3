...
CSRF_TRUSTED_ORIGINS = [
    'http://127.0.0.1',
    'http://localhost',
    'http://127.0.0.1:8000',  # Add the development server URL
]
...
INSTALLED_APPS = [
    ...
    "django_extensions",
    'audits',
    'standards',  # Register the standards app
    'standards.apps.StandardsConfig',  # Use the full path to the app config
]
